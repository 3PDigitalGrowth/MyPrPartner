    ...
    phases: [
      {
        ...
        sub: "",
        modules: [
          { month: 1, title: "Defining crisis readiness", note: "Mindset before methodology \u2014 shift from reactive to proactive and lead from presence, not panic." },
          { month: 2, title: "Issue vs. crisis: getting the distinction right", note: "Distinguish issues from crises, learn the thresholds of impact and calibrate your response." },
      ...
      },
      {
        ...
        sub: "",
        modules: [
          { month: 4, title: "Four levels of safety in crisis communication", note: "Creating safety so your stakeholders can hear you, trust you, and follow your leadership." },
          { month: 5, title: "Leading from energetic safety", note: "Heart-brain coherence and the foundation of your ability to lend deep safety to those you\u2019re leading." },
          { month: 6, title: "Strategic storytelling in crisis communication", note: "Crisis as an onion and strategic narrative layering so you can take stakeholders on the journey." },
        ],
      },
      {
        label: "Months 7 to 9",
        sub: "",
        modules: [
          { month: 7, title: "From tragedy to trust: Maple Leaf Foods masterclass", note: "Bringing everything together: mindset, emotion, safety, coherence, and layered storytelling." },
          { month: 8, title: "Timelines of response & owning your narrative", note: "The difference between owning your narrative and losing control of it." },
          { month: 9, title: "Crisis as a Leadership Mirror", note: "Use crisis moments to reflect, recalibrate, and rise into a more integrated leadership presence." },
        ],
      },
      {
        ...
        sub: "",
        modules: [
          { month: 10, title: "Owning accountability without fuelling liability", note: "The art of the public apology: high-integrity communication that honours stakeholders and strengthens trust." },
          ...
          { month: 12, title: "Becoming the Crisis Ready\u00AE Communicator", note: "Step into your role as a calm, credible voice in the noise of uncertainty." },
        ],
      },
    ],
  },
