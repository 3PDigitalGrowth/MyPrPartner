...
export const NavTrigger = forwardRef<HTMLButtonElement, NavTriggerProps>(function NavTrigger(
  ...
  return (
    <button
      ...
      id={id}
      type="button"
      className="flex items-center gap-1 whitespace-nowrap text-[15px] font-medium text-text-dark outline-none transition-colors hover:text-teal focus-visible:ring-2 focus-visible:ring-teal focus-visible:ring-offset-2"
