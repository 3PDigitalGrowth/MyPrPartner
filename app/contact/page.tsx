...
const funnelCards: FunnelCard[] = [
  {
    ...
    body: "Four programs, one sector-matched approach. Browse the program overview to find the one built for your team before you send a message.",
  ...
  },
  {
    ...
    body: "Australia’s premier crisis communications training - Built in association with the Crisis Ready Institute",
  ...
  },
  {
    ...
    body: "Before you send an enquiry, there's a good chance we've already written about it. Practical PR tips and commentary.",
...
const resourceCards: FunnelCard[] = [
  {
    ...
    body: "Five simple steps to becoming a trusted voice in your field. No cost, no catch.",
    cta: "Get the guide",
  ...
  },
  {
    ...
    body: "Assess your organisation's vulnerability to a reputational crisis in 10 minutes - a 30-point self-assessment from CRC Public Relations.",
