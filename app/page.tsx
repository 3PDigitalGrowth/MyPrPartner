      ...
      <main className="pt-[112px] lg:pt-[112px]">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center animate-fade-in-up">
              <div className="lg:col-span-7">
                <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-3">ABOUT MY PR PARTNER</p>
        ...
        <section className="bg-white">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 pb-16 animate-fade-in-up">
            <p className="text-center text-[11px] font-medium text-gray-400 tracking-[0.15em] uppercase mb-5">AS SEEN IN</p>
        ...
        <section className="bg-bg-grey py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-[700px] text-center mb-12 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">WHY MY PR PARTNER</p>
        ...
        <section id="programs" className="bg-bg-grey py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">OUR PROGRAMS</p>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">WHAT&apos;S INCLUDED</p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-16 items-center animate-fade-in-up">
              ...
              <div className="md:col-span-3">
                <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-3">FROM THE FOUNDERS</p>
        ...
        <section id="experts" className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">YOUR EXPERT TEAM</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up">
              {[
                { image: "/images/expert-lyall.jpg", name: "Lyall Mercer", title: "Head of Content, My PR Partner | Lead Strategist, CRC Public Relations", bio: "Former journalist and 25-year PR career spanning six continents. Lyall has consulted national and international companies, governments, executives, and industry leaders in crisis communications and reputation management." },
                { image: "/images/expert-melissa.jpg", name: "Melissa Agnes", title: "Founder, Crisis Ready Institute (USA)", bio: "Globally recognised authority on crisis communication and crisis leadership. Creator of the Crisis Ready\u00AE Model and best-selling author. Presenting exclusively through My PR Partner in Australasia." },
                { image: "/images/expert-deborah.jpg", name: "Deborah Hileman", title: "President, Institute for Crisis Management (USA)", bio: "35+ years experience training executives across the globe to prevent, respond to, and mitigate crises across public and private sectors." },
              ].map((expert) => (
        ...
        <section className="bg-bg-grey py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">HOW IT WORKS</p>
        ...
        <section id="pricing" className="bg-bg-grey pt-20 pb-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">SUBSCRIPTION LEVELS</p>
            ...
            <div className="hidden md:grid md:grid-cols-4 gap-6 animate-fade-in-up">
              {[
                ...
                <div key={tier.name} className={`bg-white rounded-card p-8 border flex flex-col ${tier.highlighted ? "border-teal border-t-[3px] shadow-[0_4px_16px_rgba(7,175,187,0.15)]" : "border-gray-200 shadow-card"}`}>
                  {tier.highlighted && <span className="inline-block self-start rounded-full bg-teal px-3 py-1 text-[11px] font-medium text-white uppercase mb-3">Popular</span>}
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">WHAT OUR CLIENTS SAY</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up">
              {[
        ...
        <section className="bg-white pt-20 pb-16">
          <div className="mx-auto max-w-[720px] px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 animate-fade-in-up">
              <p className="text-[12px] font-medium uppercase tracking-[0.12em] text-teal mb-4">COMMON QUESTIONS</p>
