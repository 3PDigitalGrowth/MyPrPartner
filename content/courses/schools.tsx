...
export const schoolsContent: CourseContent = {
    ...
    items: [
      {
        ...
        bio: "Former journalist with a 25-year PR career spanning six continents. Lyall has guided Australian schools, charities, associations, businesses and governments through crisis moments and reputation-building campaigns for over 15 years.",
      },
      {
        image: "/images/schools/schools-persona-crisis.jpg",
        name: "Tim Sterne",
  ...
  sidebar: {
    ...
    price: "$X,XXX",
    priceCurrencyNote: "AUD per school, per year",
    pricePlanNote: "Monthly payment plans available at checkout.",
    tierSelectorLabel: "Select your school size",
    defaultTierId: "medium",
    tiers: [
      {
        id: "small",
        label: "Small school",
        description: "Up to 300 students",
        price: "$X,XXX",
        priceCurrencyNote: "AUD per school, per year",
      },
      {
        id: "medium",
        label: "Medium school",
        description: "301 to 800 students",
        price: "$X,XXX",
        priceCurrencyNote: "AUD per school, per year",
      },
      {
        id: "large",
        label: "Large school or multi-campus",
        description: "800+ students or multi-campus",
        price: "$X,XXX",
        priceCurrencyNote: "AUD per school, per year",
      },
    ],
